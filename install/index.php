...
$sql = "UPDATE hotshoe_settings SET siteTitle='".$_POST['siteName']."' WHERE siteID=0";
...
<div class="jumbotron text-center errorpadding">
    <div class="container">
      <div class="row">
        ...
        <p>The default username is admin and password is pass</p>
